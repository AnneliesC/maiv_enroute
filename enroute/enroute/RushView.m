...
-(void)createRush{
    ...
    if([self.rushChallenge.challengeType  isEqual: @"none"]){
...
-(void)updateView{
    ...
    NSString *titleText = [NSString stringWithFormat:@"%@", self.rushChallenge.title];
    ...
    NSString *descriptionText = [NSString stringWithFormat:@"%@", self.rushChallenge.info];
